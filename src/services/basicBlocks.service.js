...
const getActivity = () => {
    return {
        ...
        defaultRequirements: [
            ...
            {id: 3, name: "Iniciativa", max: "student ve své práci nápadně projevoval touhu nabídnout vlastní možnosti" +
            ...
            {id: 4, name: "Samostatnost", max: "student se z velké části spoléhal pouze na vlastní síly, sám navrhoval i " +
                    "realizoval řešení. Vedoucí hrál vedlejší roli, radil a řídil bez přímého zásahu do díla."},
    ...
    return {
        ...
        defaultRequirements: [
            {id: 1, name: "Použitelnost, aplikovatelnost v praxi", max: "Podrobný výklad a ověření výsledků. Výsledky " +
                    "práce mohou být sdílené vnějšímu světu. Práce je připravena k použítí a poslouží jako užitečný nástroj " +
            ...
            {id: 3, name: "Systematičnost analýzy", max: "práce obsahuje jasně definované metody a techniky řešení zkoumané " +
                    "problematiky, další vývoj a analýza jsou těmito daty podložená. Popsané výsledky a průběh analýzy " +
                    "jsou konzistentní a logický se na sebe navazují."},
            {id: 4, name: "Replikovatelnost závěru", max: "popsané závěry jsou podložené průběžnými výsledky a komentáři" +
                    ", které k těmto závěrům vedly. Po provedení popsaných kroků lze práci zopakovat s dosážením stejných výsledků."},
        ],
...
const getLanguageLevel = () => {
    return {
        ...
        defaultRequirements: [
            {id: 1, name: "Adekvatnost rozsahu", max: "rozsah vypracovaného textu je dostačující pro pochopení náležitosti " +
                    "prací a průběhu její plnění. Dle studijních predpisů u bakalářských prací dostačujícím rozsahem se považuje 20-40 normostran."},
            {id: 2, name: "Formatování", max: "práce je logicky rozdělena do správně očílovaných kapitol a podkapitol, " +
            ...
            {id: 3, name: "Gramatické chyby, interpunkce, překlepy", max: "práce neobsahuje žádné gramatické a interpunkční chyby, ani překlepy."},
            ...
            {id: 5, name: "Čitelnost", max: "během čtení práce, myšlenky autora jsou lehce pochopitelné. " +
                    "Text je napsán srozumitelně a stylistycky \"příjemně\"."},
            {id: 6, name: "Použití odborného jazyku", max: "student lehce a správně používá slovy a výrazy spojené s oborem " +
                    "a tématem."},
...
const getCitation = () => {
    return {
        ...
        defaultRequirements: [
            ...
            {id: 2, name: "Dostatečnost citaci", max: "práce je dostatečně ocitována."},
            {id: 3, name: "Kvalita zdrojů", max: "využití odborných vědeckých článků, které pátří ke zkoumané problematice. " +
                    "Použití nové literatury, student se vyhnul použití zastaralých pro daný problém informací."},
        ],
        nextFrame: "finalMark"
    };
}
